...
export const AVAILABLE_MODELS = [
  ...
  { id: 'deepseek/deepseek-v4-pro', name: 'DeepSeek V4 Pro', provider: 'DeepSeek', contextLength: '1M', inputCost: '$0.435', outputCost: '$0.87' },
  { id: 'deepseek/deepseek-v4-flash', name: 'DeepSeek V4 Flash (Paid)', provider: 'DeepSeek', contextLength: '1M', inputCost: '$0.10', outputCost: '$0.20' },
  ...
  { id: 'minimax/minimax-m2.7', name: 'MiniMax M2.7', provider: 'MiniMax', contextLength: '205K', inputCost: '$0.279', outputCost: '$1.20' },
  { id: 'mistralai/mistral-large', name: 'Mistral Large', provider: 'Mistral AI', contextLength: '128K', inputCost: '$2', outputCost: '$6' },
  { id: 'moonshotai/kimi-k2.6', name: 'Kimi K2.6 (Paid)', provider: 'Moonshot AI', contextLength: '262K', inputCost: '$0.73', outputCost: '$3.49' },
